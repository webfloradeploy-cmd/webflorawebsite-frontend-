...
export default function SEOContentBlock({ 
  ...
  paragraphs = [
    <>
      <strong className="text-white font-medium">Webflora Technologies</strong> provides comprehensive digital solutions for businesses in Patna, Bihar, and across India. As a premier technology partner, our expertise spans across <Link href="/it-company-in-patna/website-development-company-in-patna" className="text-[#FF3B00] hover:underline font-medium">website development</Link>, <Link href="/ecommerce-website-development" className="text-[#FF3B00] hover:underline font-medium">eCommerce website development</Link>, <Link href="/it-company-in-patna/software-development-company-in-patna" className="text-[#FF3B00] hover:underline font-medium">Custom Software Development</Link> engineering, and specialized <Link href="/it-company-in-patna/software-development-company-in-patna" className="text-[#FF3B00] hover:underline font-medium">ERP Development Company</Link> systems.
    </>,
    <>
