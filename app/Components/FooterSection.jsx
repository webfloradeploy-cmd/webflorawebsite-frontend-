  ...
  return (
    <footer className="relative w-full pt-20 pb-28 sm:pb-20 md:pb-10 overflow-hidden bg-[#050505] text-neutral-300 selection:bg-[#ff3b00] selection:text-white">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0" aria-hidden="true">
        <div className="absolute top-[20%] left-[10%] w-96 h-96 rounded-full opacity-[0.08]" style={{ background: "radial-gradient(circle, #ff3b00 0%, transparent 70%)" }} />
        <div className="absolute bottom-[10%] right-[5%] w-80 h-80 rounded-full opacity-[0.1]" style={{ background: "radial-gradient(circle, #1e3a8a 0%, transparent 70%)" }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative group w-full p-[1px] rounded-3xl bg-gradient-to-r from-white/10 via-white/5 to-white/10 overflow-hidden mb-20 hover:from-[#ff3b00]/50 hover:via-[#ff3b00]/20 hover:to-[#ff3b00]/50 transition-all duration-700">
          ...
          <div className="relative bg-[#0a0a0a]/90 backdrop-blur-xl rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border border-white/5">
            ...
            <Link
              href="/contact"
              aria-label="Start your project with Webflora Technologies"
              className="group/btn relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#d93200] hover:bg-[#c22d00] text-white text-sm font-bold tracking-wide rounded-full overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(217,50,0,0.4)] hover:scale-105"
            >
        ...
        <div className="mb-12 border-t border-white/5 pt-12">
          <p className="text-neutral-300 text-sm md:text-base leading-relaxed font-light text-center max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20 border-t border-white/5 pt-16">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-8">
            ...
            <p className="text-neutral-300 text-sm leading-relaxed font-light max-w-sm">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10 w-fit mt-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-neutral-300 font-mono">Udyam No: UDYAM-BR-26-0183379</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4">
              {[
                { icon: "logos:linkedin", url: "https://www.linkedin.com/company/webfloratechnologies/", label: "LinkedIn" },
                { icon: "logos:facebook", url: "https://www.facebook.com/profile.php?id=61580014195502", label: "Facebook" },
                { icon: "logos:instagram", url: "https://www.instagram.com/webflora.technologies?igsh=aW5lNnk1Z2g1ZXRq", label: "Instagram" },
                { icon: "logos:x", url: "#", label: "Twitter" },
                ...
                <a
                  ...
                  className="magnetic-wrap w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/5 text-neutral-300 hover:text-white hover:border-[#ff3b00]/50 hover:bg-[#ff3b00]/10 hover:shadow-[0_0_15px_rgba(255,59,0,0.3)] transition-all duration-300"
                >
                  <SafeIcon
                    icon={social.icon}
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-10 md:gap-8">
            ...
            <div className="md:col-span-4 flex flex-col space-y-6">
              ...
              <address className="not-italic flex flex-col space-y-4 text-sm text-neutral-300 font-light">
              ...
              <div className="pt-4">
                ...
                <ul className="flex flex-col space-y-2 text-xs text-neutral-300">
                  <li>
        ...
        <div className="relative pt-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-light text-neutral-300">
            ...
            <div className="flex items-center gap-6">
              <Link href="/privacy-policy" className="hover:text-white transition-colors cursor-pointer">Privacy & Security</Link>
              <Link href="/sitemap.xml" className="hover:text-white transition-colors cursor-pointer">Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="flex flex-col space-y-6">
      ...
      <ul className="flex flex-col space-y-4">
        {links.map((link, i) => {
          ...
          const linkClass = "group flex items-center text-sm text-neutral-300 hover:text-[#ff3b00] transition-colors font-light cursor-pointer";
          const content = (
            <>
              ...
              {text}
              {text === "AI Chatbots" && (
                <span className="ml-2 text-[10px] font-black uppercase tracking-wider bg-[#ff3b00] text-black px-2 py-0.5 rounded">
                  SaaS
                </span>
              )}
              {badgeIndex === i && (
